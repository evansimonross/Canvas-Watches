...
var time = {
    ...
    drh: { name: 'drh', declaration: "360*((hour % 12)/12)+360*(minute/(12*60))+360*(second/(12*60*60))" },
    drh24: { name: 'drh24', declaration: "360*(hour/24)+360*(minute/(24*60))+360*(second/(24*60*60))" },
