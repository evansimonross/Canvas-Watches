...
function weekday(x) { return 0; }
function month_func(x) { return 0; }
function hexa2(x) { return 0; }
...
function drawComponents() {
  ...
  //drawNumbers(0, 0, 220, 0, 0, 360, , undefined, 1, "n", 14, "BebasNeue", "#ffffff", (var_screen===2) ? 100 : 0)
