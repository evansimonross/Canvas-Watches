...
function drawClock() {
  ...
  weekday = function(x) { return 0; }
  month_func = function(x) { return 0; }
  hexa2 = function(x) { return "00"; }
...
function drawComponents() {
  ...
  drawNumbers(0, 0, 220, 0, -52, 50, 5, 55, 5, "n", 18, "BebasNeue Regular", "#ffffff", 0)
  drawNumbers(0, 0, 220, 0, -50, 52, 55, 5, 5, "n", 18, "BebasNeue Regular", "#ffffff", 100)
  drawNumbers(0, 0, 220, 0, 128, 230, 5, 55, 5, "n", 18, "BebasNeue Regular", "#ffffff", 0)
  drawNumbers(0, 0, 220, 0, 130, 232, 55, 5, 5, "n", 18, "BebasNeue Regular", "#ffffff", 100)
  ...
  drawText(125, (dd===dn) && (dh23>11) ? ((-30*drm)/360) : 0, 0, month_func((dnn+0)), 30, "Euro Caps", "#000000", 100)
  drawText(125, (dd===dn) && (dh23>11) ? (30-((30*drm)/360)) : 30, 0, month_func((dnn+1)), 30, "Euro Caps", "#000000", 100)
